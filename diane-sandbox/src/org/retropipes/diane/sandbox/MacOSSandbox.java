	...
	protected String getDirectory(final SystemDir dir) {
		switch (dir) {
			...
			case AUTOSAVED_INFORMATION:
				...
				if (autosave == null) {
					autosave = this.getLibraryFallbackDirectory() + File.pathSeparator
			...
			case DOCUMENTS:
				...
				if (docs == null) {
					docs = this.getLibraryFallbackDirectory() + File.pathSeparator
			...
			case DESKTOP:
				...
				if (desktop == null) {
					desktop = this.getLibraryFallbackDirectory() + File.pathSeparator
			...
			case PICTURES:
				...
				if (pictures == null) {
					pictures = this.getLibraryFallbackDirectory() + File.pathSeparator
			...
			case SYSTEM_CACHES:
				...
				if (sysCaches == null) {
					sysCaches = this.getLibraryFallbackDirectory() + File.pathSeparator
