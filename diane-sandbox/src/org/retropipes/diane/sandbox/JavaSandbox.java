...
final class JavaSandbox extends Sandbox {
    ...
    protected String getDirectory(final SystemDir dir) {
        return switch (dir) {
            ...
            case DOCUMENTS ->
                this.getLibraryFallbackDirectory() + File.pathSeparator + JavaSandbox.DOCUMENTS_FALLBACK_DIR;
            case DESKTOP -> this.getLibraryFallbackDirectory() + File.pathSeparator + JavaSandbox.DESKTOP_FALLBACK_DIR;
            case DOWNLOADS ->
                this.getLibraryFallbackDirectory() + File.pathSeparator + JavaSandbox.DOWNLOADS_FALLBACK_DIR;
            ...
            case PICTURES ->
                this.getLibraryFallbackDirectory() + File.pathSeparator + JavaSandbox.PICTURES_FALLBACK_DIR;
            case SHARED_PUBLIC ->
