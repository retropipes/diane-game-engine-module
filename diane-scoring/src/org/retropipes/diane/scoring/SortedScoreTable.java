...
package org.retropipes.diane.scoring;
...
public class SortedScoreTable extends ScoreTable {
    public static SortedScoreTable readSortedScoreTable(final DataIOReader xdr) throws IOException {
    ...
    public void writeSortedScoreTable(final DataIOWriter xdw) throws IOException {
